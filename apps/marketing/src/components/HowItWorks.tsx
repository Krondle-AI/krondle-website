    ...
    <section id="how-it-works" className="bg-white dark:bg-slate-800 px-6 py-24 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute top-10 left-0 right-0 h-0.5 bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-600 hidden md:block" style={{ width: 'calc(100% - 80px)', marginLeft: '40px', marginRight: '40px' }} />
