        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <Card className={`relative overflow-hidden border-2 ${plan.borderColor} ${plan.popular ? 'shadow-2xl scale-105' : 'shadow-lg hover:shadow-xl'} transition-all duration-300 h-full bg-gradient-to-br ${plan.gradient}`}>
                <div className="p-8">
                  {/* Plan Header */}
                  ...
                  {/* CTA Button */}
                  <Link to="/agendar-demo" className="block mb-8">
                    <Button 
                  ...
                  <div className="space-y-3">
                    {plan.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start gap-3">
                        <Check className={`w-5 h-5 flex-shrink-0 mt-0.5 ${plan.popular ? 'text-cyan-600' : 'text-slate-600'}`} />
